...
public class RoutingMapTree {
    ...
    public void performAction(String ActionMessage)
            throws ExchangeException, SetException, MobilePhoneException {
    ...
    public LinkedList<Exchange> findCallPath(int a, int b)
            throws ExchangeException, MobilePhoneException {
    ...
    public void movePhone(int a, int b)
            throws ExchangeException, MobilePhoneException, SetException {
        Exchange e = this.getNode(b);
        if (e == null) {
            System.out.println("Node does not Exist in the tree");
        } 
    ...
    //         throws SetException, ExchangeException, MobilePhoneException {
